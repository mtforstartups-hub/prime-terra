        ...
        >
          <motion.div variants={fadeUp}>
            ...
            <p className="text-charcoal-light text-lg leading-relaxed mb-10">
              Raahuul Jaain is a globally-minded professional with deep
              technical expertise, financial acumen, and hands-on
              entrepreneurial experience. With a strong foundation in finance
              and technology, active involvement in IT consulting, and
              significant jewelry and precious metals industry background, he
              brings a comprehensive perspective to business strategy,
              investment analysis, and technology-driven transformation
              initiatives.
            </p>
            <motion.div variants={fadeUp}>
              <p
              ...
              >
                &ldquo;Today, Raahuul leverages this powerful combination of IT
